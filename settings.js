...
global.alivemsg = `❤සුනෙත් offline but ඔහුගේ සහකරු වන මම online 😜🤫´
❤කොහොමද මැණික ඉතින් ඔයාට හොදින් ඇති කියලා හිතනවා🥺...❤☺️මතකද මාව තාම ඔයාට මැණික😑` //Costomize Alive Message (type your message in `` )
...
global.ownername = "❤KING SUNETH MD❯❯" // owner name
...
global.botname = '𝙍𝙀𝘿╺ 𝘿𝙍𝘼𝙂𝙊𝙉 - 𝘉𝘖𝘛 ❤SUNETH' //ur bot name
global.packname = "Bot Sticker SUNETH" // sticker packname
global.author = "𝙍𝙀𝘿╺ 𝘿𝙍𝘼𝙂𝙊𝙉 SUNETH BRO" // sticker author
...
global.mess = {
    success: 'Done ✅',
    admin: 'Only Admins can use it!😉 දැන් සැපද ඉතින් 😜',
    botAdmin: 'Bot wants to be an Admin😥',
    owner: 'Only Owner can use this!😉 SUNETH ට විතරයි 😂',
    group: 'Feature Used Only For Groups! ගෘප් වලට විතරයි 😂 '
    private: 'This Features Only For Private Chat!',
    bot: 'This Feature Is Only For Bot😝',
    wait: '👉👈Pleas Wait...ටිකක් ඉන්න මැණික🥺',
